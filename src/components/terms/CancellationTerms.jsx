    ...
    return (
        <div className="relative px-4 sm:px-6 lg:px-8 font-worksans-light">
            <div className="text-lg max-w-prose mx-auto">
                ...
                Usted acepta que podemos desactivar o cancelar sus derechos de uso del Servicio (incluida su Cuenta) o cancelar su Plan (i) si creemos que ha incumplido o actuado de forma incompatible con estas Condiciones y (ii) en cualquier momento y por cualquier motivo a nuestra entera discreción si es titular de una suscripción a un Plan gratuito. Usted acepta que cualquier desactivación o terminación por las razones anteriores puede ser efectuada sin previo aviso a usted y que no seremos responsables ante usted o cualquier tercero por cualquier desactivación de su Cuenta o terminación de su Plan.
                </p>
            </div>
            ...
            <div className="text-lg max-w-prose mx-auto">
                <h4>
                    <span className="mt-4 block text-lg leading-8 font-medium tracking-tight text-gray-600 sm:text-lg">
                        5.3 Después del cese o de la anulación
                    </span>
                </h4>
                <p className="mt-4 text-xl text-gray-500 leading-8">
